...
import com.hawk.codegen.database.convert.DomainConverterFactory;
import com.hawk.codegen.database.convert.IDomainConverter;
...
public class App {
	...
	private static void writeDomain(List<Domain> domainList,IProjectConfigure projectConfigure) throws IOException, Exception{
		...
		String directory = ProjectTools.computeProjectSourceDirectory(projectConfigure.getProjectRootDirectory(),projectConfigure.getRootPackage(),projectConfigure.getSubPackage(), "domain") ;		
	...
	private static void writeMapper(List<Domain> domainList,IProjectConfigure projectConfigure) throws Exception{
		...
		String directory = ProjectTools.computeProjectSourceDirectory(projectConfigure.getProjectRootDirectory(),projectConfigure.getRootPackage(),projectConfigure.getSubPackage(), "mapper") ;		
	...
	private static void writeSqlMapper(List<Domain> domainList,IProjectConfigure projectConfigure,EnumDialect dialect) throws Exception{
		...
		String directory = ProjectTools.computeProjectResourceDirectory(projectConfigure.getProjectRootDirectory(),projectConfigure.getRootPackage(),projectConfigure.getSubPackage(), "mapper") ;		
