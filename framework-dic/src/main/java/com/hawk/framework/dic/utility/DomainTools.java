	...
	public static void copy(Object source , Object target){
		...
		for (Field field : fields){
			...
			try {
				...
				if (reader == null)
					continue;
				if (fieldName.equals("id")||fieldName.equals("code")||fieldName.equals("name") ||fieldName.equals("comment")||fieldName.equals("displayName"))
				pd = new PropertyDescriptor("object" +  fieldName.replaceFirst(fieldName.substring(0, 1), fieldName.substring(0, 1).toUpperCase()) , targetClass);
