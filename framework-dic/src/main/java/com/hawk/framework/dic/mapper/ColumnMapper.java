...
public interface ColumnMapper  {
	 ...
	 * @return 查询到的记录
	 */
	ColumnDomain load(@Param("objectId")String objectId );
	 ...
	 */
	List<ColumnDomain> loadDynamic(Map<String,Object> params);
	 ...
	 * @return 符合条件的记录，如果查询不到记录，返回的是空记录数的List
	 */
	List<ColumnDomain> loadDynamicPaging(Map<String,Object> params);
	...
	/**
	 * 插入记录
	 * @param ColumnDomain 表字段对象
	 * @return 插入的记录数
	 */
	int insert(ColumnDomain columnDomain);
	 ...
	 * @return 更新的记录数
	 */
	int update(ColumnDomain columnDomain);
	 ...
	 * @return 更新的记录数
	 */
	int updateWithoutNull(ColumnDomain columnDomain);
