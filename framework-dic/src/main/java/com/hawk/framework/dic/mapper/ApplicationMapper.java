...
public interface ApplicationMapper  {
	 ...
	 * @return 查询到的记录
	 */
	ApplicationDomain load(@Param("objectId")String objectId );
	 ...
	 */
	List<ApplicationDomain> loadDynamic(Map<String,Object> params);
	 ...
	 * @return 符合条件的记录，如果查询不到记录，返回的是空记录数的List
	 */
	List<ApplicationDomain> loadDynamicPaging(Map<String,Object> params);
	...
	/**
	 * 插入记录
	 * @param ApplicationDomain 应用,一个应用一个package,对应很多表.
	 * @return 插入的记录数
	 */
	int insert(ApplicationDomain applicationDomain);
	 ...
	 * @return 更新的记录数
	 */
	int update(ApplicationDomain applicationDomain);
	 ...
	 * @return 更新的记录数
	 */
	int updateWithoutNull(ApplicationDomain applicationDomain);
