...
public interface TableMapper  {
	 ...
	 * @return 查询到的记录
	 */
	TableDomain load(@Param("objectId")String objectId );
	 ...
	 */
	List<TableDomain> loadDynamic(Map<String,Object> params);
	 ...
	 * @return 符合条件的记录，如果查询不到记录，返回的是空记录数的List
	 */
	List<TableDomain> loadDynamicPaging(Map<String,Object> params);
	...
	/**
	 * 插入记录
	 * @param TableDomain 表对象
	 * @return 插入的记录数
	 */
	int insert(TableDomain tableDomain);
	 ...
	 * @return 更新的记录数
	 */
	int update(TableDomain tableDomain);
	 ...
	 * @return 更新的记录数
	 */
	int updateWithoutNull(TableDomain tableDomain);
