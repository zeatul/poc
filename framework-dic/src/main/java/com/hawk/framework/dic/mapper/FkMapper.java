...
import com.hawk.framework.dic.domain.FkDomain;
...
public interface FkMapper  {
	...
	/**
	 * 根据主键加载记录
	 * @param objectId 主键对象ID
	 * @return 查询到的记录
	 */
	FkDomain load(@Param("objectId")String objectId );
	 ...
	 */
	List<FkDomain> loadDynamic(Map<String,Object> params);
	 ...
	 * @return 符合条件的记录，如果查询不到记录，返回的是空记录数的List
	 */
	List<FkDomain> loadDynamicPaging(Map<String,Object> params);
	 ...
	 * @return 更新的记录数
	 */
	int updateWithoutNull(FkDomain fkDomain);
