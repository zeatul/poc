...
public interface IndexMapper  {
	 ...
	 * @return 查询到的记录
	 */
	IndexDomain load(@Param("objectId")String objectId );
	 ...
	 */
	List<IndexDomain> loadDynamic(Map<String,Object> params);
	 ...
	 * @return 符合条件的记录，如果查询不到记录，返回的是空记录数的List
	 */
	List<IndexDomain> loadDynamicPaging(Map<String,Object> params);
	...
	/**
	 * 插入记录
	 * @param IndexDomain 索引
	 * @return 插入的记录数
	 */
	int insert(IndexDomain indexDomain);
	 ...
	 * @return 更新的记录数
	 */
	int update(IndexDomain indexDomain);
	 ...
	 * @return 更新的记录数
	 */
	int updateWithoutNull(IndexDomain indexDomain);
