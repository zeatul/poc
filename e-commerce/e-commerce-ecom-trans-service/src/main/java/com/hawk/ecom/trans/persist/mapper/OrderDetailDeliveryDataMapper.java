 ...
 * @author Gen
 */
public interface OrderDetailDeliveryDataMapper  {
	 ...
	 */
	List<OrderDetailDeliveryDataDomain> loadDynamic(Map<String,Object> params);
	 ...
	 * @return 符合条件的记录，如果查询不到记录，返回的是空记录数的List
	 */
	List<OrderDetailDeliveryDataDomain> loadDynamicPaging(Map<String,Object> params);
	...
	/**
	 * 插入记录
	 * @param OrderDetailDeliveryDataDomain 交付数据
	 * @return 插入的记录数
	 */
	int insert(OrderDetailDeliveryDataDomain orderDetailDeliveryDataDomain);
	 ...
	 * @return 更新的记录数
	 */
	int update(OrderDetailDeliveryDataDomain orderDetailDeliveryDataDomain);
	 ...
	 * @return 更新的记录数
	 */
	int updateWithoutNull(OrderDetailDeliveryDataDomain orderDetailDeliveryDataDomain);
