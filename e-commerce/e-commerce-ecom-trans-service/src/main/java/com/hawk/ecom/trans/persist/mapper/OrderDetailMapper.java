...
public interface OrderDetailMapper  {
	 ...
	 * @return 查询到的记录
	 */
	OrderDetailDomain load(@Param("id")Integer id );
	 ...
	 */
	List<OrderDetailDomain> loadDynamic(Map<String,Object> params);
	 ...
	 * @return 符合条件的记录，如果查询不到记录，返回的是空记录数的List
	 */
	List<OrderDetailDomain> loadDynamicPaging(Map<String,Object> params);
	...
	/**
	 * 插入记录
	 * @param OrderDetailDomain 订单明细
	 * @return 插入的记录数
	 */
	int insert(OrderDetailDomain orderDetailDomain);
	 ...
	 * @return 更新的记录数
	 */
	int update(OrderDetailDomain orderDetailDomain);
	 ...
	 * @return 更新的记录数
	 */
	int updateWithoutNull(OrderDetailDomain orderDetailDomain);
