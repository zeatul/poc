...
public interface OrderOperationMapper  {
	 ...
	 * @return 查询到的记录
	 */
	OrderOperationDomain load(@Param("id")Integer id );
	 ...
	 */
	List<OrderOperationDomain> loadDynamic(Map<String,Object> params);
	 ...
	 * @return 符合条件的记录，如果查询不到记录，返回的是空记录数的List
	 */
	List<OrderOperationDomain> loadDynamicPaging(Map<String,Object> params);
	...
	/**
	 * 插入记录
	 * @param OrderOperationDomain 订单操作记录
	 * @return 插入的记录数
	 */
	int insert(OrderOperationDomain orderOperationDomain);
	 ...
	 * @return 更新的记录数
	 */
	int update(OrderOperationDomain orderOperationDomain);
	 ...
	 * @return 更新的记录数
	 */
	int updateWithoutNull(OrderOperationDomain orderOperationDomain);
