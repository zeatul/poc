...
(
   ...
   bsi_cash_coupon_status tinyint unsigned comment '代金券状态',
   bsi_cash_coupon_type varchar(50) comment '代金券类型',
   bsi_cash_coupon_period tinyint unsigned comment '代金券保险月份数',
...
(
   ...
   bsi_task_status      tinyint unsigned comment '任务状态',
   bsi_phone_model_id   integer unsigned comment '手机型号ID',
   bsi_product_id       integer unsigned comment '碎屏险产品ID',
   imei                 varchar(200) comment '设备唯一的串号',
   bsi_benef_id_typ     tinyint unsigned comment '证件类型',
   bsi_benef_id_number  varchar(50) comment '证件号码',
   bsi_benef_birthday   varchar(50) comment '投保者生日',
   bsi_benef_sex        tinyint unsigned comment '投保者性别',
...
(
   ...
   charge_data_size     integer unsigned comment '充值流量',
...
(
   ...
   user_code            varchar(50) comment '用户编号',
   mobile_number        varchar(20) comment '手机号码',
   order_status         integer unsigned comment '订单状态',
