...
(
   ...
   order_code           varchar(50) not null comment '订单编号',
   user_code            varchar(50) not null comment '用户编号',
   order_deduction      decimal(17,2) not null comment '订单减免',
...
(
   ...
   original_unit_price  decimal(17,2) not null comment '原单价',
   trans_unit_price     decimal(17,2) not null comment '成交单价',
   orde_detail_original_price decimal(17,2) not null comment '订单明细支付原总价',
   orde_detail_trans_price decimal(17,2) not null comment '订单明细支付总价',
   currency             smallint unsigned not null comment '币种',
...
(
   ...
   delivery_status      tinyint unsigned not null comment '交付状态(最终状态是这里维护的)',
   delivery_status_memo varchar(200) not null comment '交付状态备注',
   ...
   outer_order_msg2     varchar(200) comment '外部交易描述2(后续描述)',
   outer_order_status2  varchar(50) comment '外部交易状态2(后续状态)',
...
(
   ...
   order_code           varchar(50) not null comment '订单编号',
   user_code            varchar(50) not null comment '用户编号',
   freight_charge       decimal(17,2) not null comment '运费',
   create_user_code     varchar(50) comment '创建者',
   create_date          timestamp(3) null comment '创建日期',
   update_user_code     varchar(50) comment '更新者',
   update_date          timestamp(3) null comment '更新日期',
