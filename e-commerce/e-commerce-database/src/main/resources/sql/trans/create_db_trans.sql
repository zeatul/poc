...
(
   ...
   original_unit_price  decimal(15,4) not null comment '显示单价',
   trans_unit_price     decimal(15,4) not null comment '单价',
   orde_detail_original_price decimal(15,4) not null comment '订单明细支付原总价价',
