...
(
   ...
   product_extra1       varchar(200) comment '产品扩展属性1',
   product_extra2       varchar(200) comment '产品扩展属性2',
   product_extra3       varchar(200) comment '产品扩展属性3',
   product_extra4       varchar(200) comment '产品扩展属性4',
   product_extra5       varchar(200) comment '产品扩展属性5',
   create_user_code     varchar(50) comment '创建者',
   create_date          timestamp(3) null comment '创建日期',
   update_user_code     varchar(50) comment '更新者',
   update_date          timestamp(3) null comment '更新日期',
...
(
   ...
   sku_extra1           varchar(200) comment '产品Sku扩展属性1',
   sku_extra2           varchar(200) comment '产品Sku扩展属性2',
   sku_extra3           varchar(200) comment '产品Sku扩展属性3',
   sku_extra4           varchar(200) comment '产品Sku扩展属性4',
   sku_extra5           varchar(200) comment '产品Sku扩展属性5',
   create_user_code     varchar(50) comment '创建者',
   create_date          timestamp(3) null comment '创建日期',
   update_user_code     varchar(50) comment '更新者',
   update_date          timestamp(3) null comment '更新日期',
