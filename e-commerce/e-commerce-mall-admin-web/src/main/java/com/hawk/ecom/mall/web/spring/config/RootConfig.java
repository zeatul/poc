...
@Configuration
@Import({ DataConfig.class,EcomPayRootConfig.class, EcomTransRootConfig.class,MallAdminRootConfig.class, MuserRootConfig.class, SmsRootConfig.class, PubRootConfig.class, ProductRootConfig.class })
