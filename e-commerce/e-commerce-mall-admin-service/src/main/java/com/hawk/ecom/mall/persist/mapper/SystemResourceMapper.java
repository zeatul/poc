...
public interface SystemResourceMapper  {
	 ...
	 * @return 查询到的记录
	 */
	SystemResourceDomain load(@Param("id")Integer  id );
	 ...
	 */
	List<SystemResourceDomain> loadDynamic(Map<String,Object> params);
	 ...
	 * @return 符合条件的记录，如果查询不到记录，返回的是空记录数的List
	 */
	List<SystemResourceDomain> loadDynamicPaging(Map<String,Object> params);
	...
	/**
	 * 插入记录
	 * @param SystemResourceDomain 导航类资源管理
	 * @return 插入的记录数
	 */
	int insert(SystemResourceDomain systemResourceDomain);
	 ...
	 * @return 更新的记录数
	 */
	int update(SystemResourceDomain systemResourceDomain);
	 ...
	 * @return 更新的记录数
	 */
	int updateWithoutNull(SystemResourceDomain systemResourceDomain);
