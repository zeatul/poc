...
import com.hawk.ecom.svp.persist.mapper.BsiPhoneProductMapMapper;
...
public class BsiPhoneProdcutMapService {
	...
	@Autowired
	private BsiPhoneProductMapMapper bsiPhoneProdcutMapMapper;
	...
	public int queryProductId(long phoneModelId,int period){
		...
		List<BsiPhoneProductMapDomain> list = bsiPhoneProdcutMapMapper.loadDynamic(params);
		if (list.size() == 0)
