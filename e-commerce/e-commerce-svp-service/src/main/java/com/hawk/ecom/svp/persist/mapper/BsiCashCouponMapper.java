 ...
 * @author Gen
 */
public interface BsiCashCouponMapper  {
	 ...
	 * @return 查询到的记录
	 */
	BsiCashCouponDomain load(@Param("id")Integer id );
	 ...
	 */
	List<BsiCashCouponDomain> loadDynamic(Map<String,Object> params);
	 ...
	 * @return 符合条件的记录，如果查询不到记录，返回的是空记录数的List
	 */
	List<BsiCashCouponDomain> loadDynamicPaging(Map<String,Object> params);
	...
	/**
	 * 插入记录
	 * @param BsiCashCouponDomain 代金券
	 * @return 插入的记录数
	 */
	int insert(BsiCashCouponDomain bsiCashCouponDomain);
	 ...
	 * @return 更新的记录数
	 */
	int update(BsiCashCouponDomain bsiCashCouponDomain);
	 ...
	 * @return 更新的记录数
	 */
	int updateWithoutNull(BsiCashCouponDomain bsiCashCouponDomain);
