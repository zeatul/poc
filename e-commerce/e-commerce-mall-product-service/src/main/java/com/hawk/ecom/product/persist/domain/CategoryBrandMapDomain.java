...
/**
 * 品牌和产品目录的对应关系
 * The class is mapped to the table t_prd_category_brand_map 
 * Don't modify this file as it will be regenerated frequently.
 * @author Code-Gen 
 */
public class CategoryBrandMapDomain implements Serializable {
