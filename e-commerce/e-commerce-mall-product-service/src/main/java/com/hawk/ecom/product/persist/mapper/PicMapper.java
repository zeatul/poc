...
public interface PicMapper  {
	 ...
	 * @return 查询到的记录
	 */
	PicDomain load(@Param("id")Integer id );
	 ...
	 */
	List<PicDomain> loadDynamic(Map<String,Object> params);
	 ...
	 * @return 符合条件的记录，如果查询不到记录，返回的是空记录数的List
	 */
	List<PicDomain> loadDynamicPaging(Map<String,Object> params);
	 ...
	 * @return 插入的记录数
	 */
	int insert(PicDomain picDomain);
	 ...
	 * @return 更新的记录数
	 */
	int update(PicDomain picDomain);
	 ...
	 * @return 更新的记录数
	 */
	int updateWithoutNull(PicDomain picDomain);
