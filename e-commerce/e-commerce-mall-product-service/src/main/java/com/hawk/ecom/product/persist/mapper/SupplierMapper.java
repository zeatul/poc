...
import com.hawk.ecom.product.persist.domain.SupplierDomain;
...
public interface SupplierMapper  {
	 ...
	 * @return 查询到的记录
	 */
	SupplierDomain load(@Param("id")Integer id );
	 ...
	 */
	List<SupplierDomain> loadDynamic(Map<String,Object> params);
	 ...
	 * @return 符合条件的记录，如果查询不到记录，返回的是空记录数的List
	 */
	List<SupplierDomain> loadDynamicPaging(Map<String,Object> params);
	 ...
	 * @return 插入的记录数
	 */
	int insert(SupplierDomain supplierDomain);
	 ...
	 * @return 更新的记录数
	 */
	int update(SupplierDomain supplierDomain);
	 ...
	 * @return 更新的记录数
	 */
	int updateWithoutNull(SupplierDomain supplierDomain);
