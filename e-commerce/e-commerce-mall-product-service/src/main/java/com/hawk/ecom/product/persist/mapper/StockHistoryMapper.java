...
public interface StockHistoryMapper  {
	 ...
	 * @return 查询到的记录
	 */
	StockHistoryDomain load(@Param("id")Integer id );
	 ...
	 */
	List<StockHistoryDomain> loadDynamic(Map<String,Object> params);
	 ...
	 * @return 符合条件的记录，如果查询不到记录，返回的是空记录数的List
	 */
	List<StockHistoryDomain> loadDynamicPaging(Map<String,Object> params);
