 ...
 * @author Gen
 */
public interface AttrNameMapper  {
	 ...
	 * @return 查询到的记录
	 */
	AttrNameDomain load(@Param("id")Integer id );
	 ...
	 */
	List<AttrNameDomain> loadDynamic(Map<String,Object> params);
	 ...
	 * @return 符合条件的记录，如果查询不到记录，返回的是空记录数的List
	 */
	List<AttrNameDomain> loadDynamicPaging(Map<String,Object> params);
	...
	/**
	 * 插入记录
	 * @param AttrNameDomain 属性名表
	 * @return 插入的记录数
	 */
	int insert(AttrNameDomain attrNameDomain);
	 ...
	 * @return 更新的记录数
	 */
	int update(AttrNameDomain attrNameDomain);
	 ...
	 * @return 更新的记录数
	 */
	int updateWithoutNull(AttrNameDomain attrNameDomain);
