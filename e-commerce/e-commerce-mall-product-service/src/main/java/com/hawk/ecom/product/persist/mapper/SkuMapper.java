...
public interface SkuMapper  {
	 ...
	 * @return 查询到的记录
	 */
	SkuDomain load(@Param("id")Integer id );
	 ...
	 */
	List<SkuDomain> loadDynamic(Map<String,Object> params);
	 ...
	 * @return 符合条件的记录，如果查询不到记录，返回的是空记录数的List
	 */
	List<SkuDomain> loadDynamicPaging(Map<String,Object> params);
	...
	/**
	 * 插入记录
	 * @param SkuDomain 产品SKU
	 * @return 插入的记录数
	 */
	int insert(SkuDomain skuDomain);
	 ...
	 * @return 更新的记录数
	 */
	int update(SkuDomain skuDomain);
	 ...
	 * @return 更新的记录数
	 */
	int updateWithoutNull(SkuDomain skuDomain);
