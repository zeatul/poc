...
public interface AttrValueMapper  {
	 ...
	 * @return 查询到的记录
	 */
	AttrValueDomain load(@Param("id")Integer id );
	 ...
	 */
	List<AttrValueDomain> loadDynamic(Map<String,Object> params);
	 ...
	 * @return 符合条件的记录，如果查询不到记录，返回的是空记录数的List
	 */
	List<AttrValueDomain> loadDynamicPaging(Map<String,Object> params);
