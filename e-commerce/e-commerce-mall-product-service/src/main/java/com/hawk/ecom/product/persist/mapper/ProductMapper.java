...
public interface ProductMapper  {
	 ...
	 * @return 查询到的记录
	 */
	ProductDomain load(@Param("id")Integer id );
	 ...
	 */
	List<ProductDomain> loadDynamic(Map<String,Object> params);
	 ...
	 * @return 符合条件的记录，如果查询不到记录，返回的是空记录数的List
	 */
	List<ProductDomain> loadDynamicPaging(Map<String,Object> params);
	 ...
	 * @return 更新的记录数
	 */
	int updateWithoutNull(ProductDomain productDomain);
