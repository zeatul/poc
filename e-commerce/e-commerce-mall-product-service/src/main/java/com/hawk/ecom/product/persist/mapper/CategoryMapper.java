...
public interface CategoryMapper  {
	 ...
	 * @return 查询到的记录
	 */
	CategoryDomain load(@Param("id")Integer id );
	 ...
	 */
	List<CategoryDomain> loadDynamic(Map<String,Object> params);
	 ...
	 * @return 符合条件的记录，如果查询不到记录，返回的是空记录数的List
	 */
	List<CategoryDomain> loadDynamicPaging(Map<String,Object> params);
	...
	/**
	 * 插入记录
	 * @param CategoryDomain 产品目录
	 * @return 插入的记录数
	 */
	int insert(CategoryDomain categoryDomain);
	 ...
	 * @return 更新的记录数
	 */
	int update(CategoryDomain categoryDomain);
	 ...
	 * @return 更新的记录数
	 */
	int updateWithoutNull(CategoryDomain categoryDomain);
