...
public interface StockMapper  {
	 ...
	 * @return 查询到的记录
	 */
	StockDomain load(@Param("id")Integer id );
	 ...
	 */
	List<StockDomain> loadDynamic(Map<String,Object> params);
	 ...
	 * @return 符合条件的记录，如果查询不到记录，返回的是空记录数的List
	 */
	List<StockDomain> loadDynamicPaging(Map<String,Object> params);
	...
	/**
	 * 插入记录
	 * @param StockDomain 库存
	 * @return 插入的记录数
	 */
	int insert(StockDomain stockDomain);
	 ...
	 * @return 更新的记录数
	 */
	int update(StockDomain stockDomain);
	 ...
	 * @return 更新的记录数
	 */
	int updateWithoutNull(StockDomain stockDomain);
