...
public interface MallRoleMapper  {
	 ...
	 * @return 查询到的记录
	 */
	MallRoleDomain load(@Param("id")Integer  id );
	 ...
	 */
	List<MallRoleDomain> loadDynamic(Map<String,Object> params);
	 ...
	 * @return 符合条件的记录，如果查询不到记录，返回的是空记录数的List
	 */
	List<MallRoleDomain> loadDynamicPaging(Map<String,Object> params);
	...
	/**
	 * 插入记录
	 * @param MallRoleDomain 商城角色表
	 * @return 插入的记录数
	 */
	int insert(MallRoleDomain mallRoleDomain);
	 ...
	 * @return 更新的记录数
	 */
	int update(MallRoleDomain mallRoleDomain);
	 ...
	 * @return 更新的记录数
	 */
	int updateWithoutNull(MallRoleDomain mallRoleDomain);
