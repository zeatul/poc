...
public interface PaymentBillMapper  {
	 ...
	 * @return 查询到的记录
	 */
	PaymentBillDomain load(@Param("id")Integer id );
	 ...
	 */
	List<PaymentBillDomain> loadDynamic(Map<String,Object> params);
	 ...
	 * @return 符合条件的记录，如果查询不到记录，返回的是空记录数的List
	 */
	List<PaymentBillDomain> loadDynamicPaging(Map<String,Object> params);
	...
	/**
	 * 插入记录
	 * @param PaymentBillDomain 支付单
	 * @return 插入的记录数
	 */
	int insert(PaymentBillDomain paymentBillDomain);
	 ...
	 * @return 更新的记录数
	 */
	int update(PaymentBillDomain paymentBillDomain);
	 ...
	 * @return 更新的记录数
	 */
	int updateWithoutNull(PaymentBillDomain paymentBillDomain);
