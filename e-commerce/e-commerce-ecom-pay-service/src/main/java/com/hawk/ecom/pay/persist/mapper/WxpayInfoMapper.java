...
public interface WxpayInfoMapper  {
	 ...
	 */
	List<WxpayInfoDomain> loadDynamic(Map<String,Object> params);
	 ...
	 * @return 符合条件的记录，如果查询不到记录，返回的是空记录数的List
	 */
	List<WxpayInfoDomain> loadDynamicPaging(Map<String,Object> params);
	...
	/**
	 * 插入记录
	 * @param WxpayInfoDomain 微信支付信息
	 * @return 插入的记录数
	 */
	int insert(WxpayInfoDomain wxpayInfoDomain);
	 ...
	 * @return 更新的记录数
	 */
	int update(WxpayInfoDomain wxpayInfoDomain);
	 ...
	 * @return 更新的记录数
	 */
	int updateWithoutNull(WxpayInfoDomain wxpayInfoDomain);
