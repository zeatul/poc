...
public class AlipayConfig {
	...
	public static String NOTIFY_URL = "https://vstst.fexie.com.cn/ecom/pay/notify/alipay";
	// 页面跳转同步通知页面路径 需http://或者https://格式的完整路径，不能加?id=123这类自定义参数，必须外网可以正常访问
	// 商户可以自定义同步跳转地址
	public static String RETURN_URL = "https://vstst.fexie.com.cn/ecom/pay/wap/return/alipay";
	// 请求网关地址
